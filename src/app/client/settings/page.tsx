        ...
        <form action="/api/client/settings" method="post" className="space-y-6">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  name="business_name"
                  required
                  defaultValue={business.name || settings.business_name || ""}
              ...
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  name="phone"
                  defaultValue={business.phone || settings.phone || ""}
                  className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              </label>
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  name="website"
                  defaultValue={business.website || settings.website || ""}
                  className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              </label>
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  name="primary_market"
                  defaultValue={
                    business.primary_market || settings.primary_market || ""
                  }
                  className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              </label>
              ...
              <label className="block text-sm font-semibold text-slate-700 md:col-span-2">
                ...
                <textarea
                  ...
                  defaultValue={settings.services_offered || ""}
                  placeholder={
              ...
              <label className="block text-sm font-semibold text-slate-700 md:col-span-2">
                ...
                <textarea
                  ...
                  defaultValue={settings.services_not_offered || ""}
              ...
              <label className="block text-sm font-semibold text-slate-700 md:col-span-2">
                ...
                <textarea
                  ...
                  defaultValue={settings.important_disclaimers_or_limits || ""}
          ...
          <div className="rounded-[2rem] bg-white p-6 shadow-soft ring-1 ring-slate-200">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  ...
                  defaultValue={
                    settings.widget_quote_button_text || "Request Information"
                  }
                  className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              </label>
              ...
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  ...
                  type="color"
                  defaultValue={settings.widget_header_text_color || "#ffffff"}
                  className="mt-1 h-12 w-full rounded-xl border border-slate-300 px-3 py-2"
                />
              </label>
              <label className="block text-sm font-semibold text-slate-700">
              ...
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  ...
                  type="color"
                  defaultValue={settings.widget_button_text_color || "#0f172a"}
                  className="mt-1 h-12 w-full rounded-xl border border-slate-300 px-3 py-2"
                />
              </label>
              <label className="block text-sm font-semibold text-slate-700">
                ...
                <input
                  ...
                  defaultValue={settings.widget_call_button_text || "Call Now"}
                  className="mt-1 w-full rounded-xl border border-slate-300 px-4 py-3"
                />
              </label>
            ...
            <p className="mt-3 text-xs text-slate-500">
              The header color only changes the top part of the widget. The body
              where the questions appear stays light.
            </p>
          </div>
